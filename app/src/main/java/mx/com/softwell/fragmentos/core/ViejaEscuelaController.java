...
public class ViejaEscuelaController {

    private static ViejaEscuelaController instance=null;
    ...
    private ViejaEscuelaController(){}

    public static ViejaEscuelaController Instance(){
        if(instance==null)
            instance=new ViejaEscuelaController();
        return instance;
    }
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                try {
                    ...
                    if (status){
                        ...
                        ((LaViejaEscuela) MainActivity.GLOBALS.get("laViejaEscuelaFragment")).actualizar(juegos);
                    }else{
                        miscController.CloseWait();
                        Log.e(TAG, message);
                    }
